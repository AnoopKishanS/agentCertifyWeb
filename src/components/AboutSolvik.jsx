            ...
            <div className="container">
                <div className="about-grid">
                    <div className="about-content">
                        <ScrollReveal animation="slide-left" className="about-header-group">
                        ...
                        <ScrollReveal animation="fade-up" delay="200" className="about-visual mobile-only">
                        ...
                        <ScrollReveal animation="slide-left" className="about-details-group">
                    ...
                    <ScrollReveal animation="fade-up" delay="200" className="about-visual desktop-only">
                        <div className="terminal-window">
                            <div className="terminal-header">
                                <div className="terminal-dots">
                                    <span className="dot"></span>
