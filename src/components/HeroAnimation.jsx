        ...
        <div className="hero-animation-container">
            ...
            <div className="ha-window">
                <div className="ha-header">
                    <div className="ha-dot red"></div>
                    <div className="ha-dot yellow"></div>
                    <div className="ha-dot green"></div>
                    <div className="ha-url-bar">
                        <span className="ha-url-text">app.agentcertify.com</span>
                    </div>
                </div>
